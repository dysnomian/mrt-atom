...
export default {
  ...
  activate(state) {
    ...
    atom.notifications.addInfo('Starting Elixir test watcher.');
  },
      ...
      this.watcher = new BufferedProcess({
        ...
        stdout: (str) => {
          ...
          if (message.includes('failed')) {
            ...
            // Add message panel entry
            this.messages.attach()
            this.messages.add(new PlainMessageView({ message: 'Error', preview: message }));
          } else if (message.includes('Quote of the Day')) {
            atom.notifications.addSuccess('Successfully started watcher');
          }
        },
